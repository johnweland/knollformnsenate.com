...
import { candidateProfile, newsArticles } from "@/lib/content";

export const metadata: Metadata = {
  title: "News",
  description:
    "Verified campaign information, candidate background, and issue summaries for Chris Knoll and Minnesota Senate District 21.",
};
      ...
      <PageSection tone="paper" className="pb-10 pt-20 sm:pt-24 lg:pt-28">
        <header className="mb-16">
          ...
          <p className="mt-5 max-w-3xl border-l-4 border-surface-container-high pl-6 font-serif text-xl italic leading-8 text-muted-foreground sm:text-2xl">
            Verified campaign information, candidate background, and issue summaries for
            District 21.
          </p>
        </header>
        ...
        <section className="mb-24 grid gap-0 lg:grid-cols-12">
          <div className="group relative z-10 overflow-hidden rounded-lg shadow-2xl lg:col-span-8">
            <Link href={`/news/${featuredArticle.slug}`} className="block">
              <div className="h-[420px] w-full bg-[linear-gradient(135deg,rgba(190,0,20,0.88),rgba(64,92,158,0.82))] transition-transform duration-700 group-hover:scale-105" />
              ...
              >
                {index === 1 ? null : (
                  <Link
                    ...
                    className="group aspect-[4/3] overflow-hidden rounded-lg bg-surface-container-low"
                  >
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="relative overflow-hidden rounded-lg bg-secondary p-12 text-white shadow-2xl md:flex md:items-center md:gap-8">
            ...
            <div className="relative z-10 flex-1">
              <h2 className="text-3xl font-bold">Get the Briefing</h2>
              <p className="mt-2 max-w-md text-secondary-fixed/80">
                Get campaign information and updates from the Chris Knoll campaign.
              </p>
            </div>
          ...
          <aside className="flex flex-col justify-between rounded-lg border-l-4 border-secondary bg-surface-container-high p-8">
            <div>
              <h3 className="text-xl font-bold text-foreground">Campaign Overview</h3>
            ...
            <Button asChild variant="outline" className="mt-8 h-11 text-xs uppercase tracking-[0.18em]">
              <Link href="/about">Read Candidate Bio</Link>
            </Button>
          </aside>
        </section>
      </PageSection>
