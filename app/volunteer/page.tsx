...
export default function VolunteerPage() {
  return (
    <>
      <SplitHeroSection
        imageSrc={volunteerPageContent.heroImageSrc}
        imageAlt={volunteerPageContent.heroImageAlt}
        eyebrow={volunteerPageContent.heroEyebrow}
        title={`${volunteerPageContent.heroTitleLineOne} ${volunteerPageContent.heroTitleLineTwo}`}
        description={candidateProfile.coreMessage}
        actions={
          <>
            <Button
              asChild
              className="campaign-button-primary h-14 px-8 text-lg text-white"
            >
          ...
          <div className="relative lg:w-1/3">
            ...
            <div className="relative z-10 flex h-full flex-col justify-center p-12 text-white">
              <h3 className="text-4xl font-bold">
                {volunteerPageContent.signupTitle}
              </h3>
